...
df_calendar= (
        df_th.withColumn("anno",year(col("fecha")))
                ...
                .withColumn("diaAño", dayofyear(col("fecha")))
                 .withColumn("nombreDia", date_format(col("fecha"),"EEEE"))
...
#Materializamos el datframe como tyabla en el lh silver
df_calendar.write.mode("overwrite").saveAsTable("LH_Silver_Repaso.dimCalendarioFechaHora")
